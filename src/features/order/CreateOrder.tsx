...
import { AppDispatchType, RootStateType, store } from "../../store";
    ...
    <div className="px-4 py-6">
      ...
      <Form method="POST">
        <div className="mb-5 flex flex-col gap-2 sm:flex-row sm:items-center">
          <label defaultValue={username} className="sm:basis-40">
            First Name
          </label>
...
export async function createOrderAction({ request }: ActionFunctionArgs) {
  ...
  if (!isValidPhone(order.phone)) {
    errors.phone =
      "Please provide a valid phone number. We may call you in certain cases.";
  }
